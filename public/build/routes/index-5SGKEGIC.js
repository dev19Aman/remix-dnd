import {
  ...
  require_react
} from "/build/_shared/chunk-K3AZYGPX.js";
...
function useDragDropManager() {
  const { dragDropManager } = (0, import_react5.useContext)(DndContext);
...
function useCollector(monitor, collect, onUpdate) {
  const [collected, setCollected] = (0, import_react7.useState)(() => collect(monitor));
  const updateCollected = (0, import_react7.useCallback)(() => {
...
function useDropTarget(spec, monitor) {
  const dropTarget = (0, import_react9.useMemo)(() => new DropTargetImpl(spec, monitor), [
    monitor
  ]);
...
function useDropTargetMonitor() {
  const manager = useDragDropManager();
  return (0, import_react10.useMemo)(() => new DropTargetMonitorImpl(manager), [
    manager
  ]);
}
...
function useDropTargetConnector(options) {
  const manager = useDragDropManager();
  const connector = (0, import_react11.useMemo)(() => new TargetConnector(manager.getBackend()), [
    manager
  ]);
...
function useConnectDropTarget(connector) {
  return (0, import_react12.useMemo)(() => connector.hooks.dropTarget(), [
    connector
  ]);
}
...
// app/routes/index.tsx
function Index() {
  return /* @__PURE__ */ import_react13.default.createElement(DndProvider, {
    backend: HTML5Backend
  }, /* @__PURE__ */ import_react13.default.createElement("div", {
    className: "m-2"
  }, /* @__PURE__ */ import_react13.default.createElement("h1", {
    className: "text-2xl font-bold"
  }, "Remix Drag and Drop Example"), /* @__PURE__ */ import_react13.default.createElement("div", null, /* @__PURE__ */ import_react13.default.createElement("div", {
    style: { overflow: "hidden", clear: "both" }
  }, /* @__PURE__ */ import_react13.default.createElement(Dustbin, null)), /* @__PURE__ */ import_react13.default.createElement("div", {
    style: { overflow: "hidden", clear: "both" }
...
function Dustbin() {
  ...
  return /* @__PURE__ */ import_react13.default.createElement("div", {
    ref: drop,
    role: "Dustbin",
    className: `h-48 w-48 mr-6 mb-6 text-white float-left text-center ${backgroundColor}`
...
function Box({ name }) {
  ...
  return /* @__PURE__ */ import_react13.default.createElement("div", {
    ref: drag,
    role: "Box",
    className: `border-dashed border-gray-500 bg-white py-2 px-4 mr-6 mb-6 cursor-move float-left`,
 ...
 */
//# sourceMappingURL=/build/routes/index-5SGKEGIC.js.map
